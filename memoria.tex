...
\begin{itemize}
  ...
  FIXME: No entiendo los tres siguientes puntos... aquí deberíamos hablar de lo que nos vamos a encontrar en los siguientes capítulos, el III, IV y V.
...
FIXME: Explicar que hay python2 y python3, que son (ligeramente) incompatibles entre sí y que este proyecto se ha realizado en Python3, porque Python2 ya no se mantiene activamente.
